...
def novo_servico():
    ...
    codigo_gerado = gerar_codigo_servico()
    return render_template('cadastro.html', codigo_gerado=codigo_gerado)
...
def editar_servico(id):
    ...
    return render_template('cadastro.html', servico=servico, codigo_gerado=servico.codigo)
